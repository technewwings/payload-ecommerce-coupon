...
describe("Type Definitions", () => {
  ...
  describe("Type Safety", () => {
    ...
    it("should allow fixed totalCommission rules without providing a value", () => {
      type FixedRule = {
        totalCommission: { type: "fixed"; value?: number };
        partnerSplit: number;
      ...
      expect(rule.totalCommission.type).toBe("fixed");
    });
